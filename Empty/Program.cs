...
app.MapGet("/displayDate", async (RazorComponentRendererService razorComponentRendererService, IDatastarService datastarService) =>
{
    ...
    // var fragment = await razorComponentRendererService.RenderComponent(displayDate);
